    ...
    $try:try {
      ...
      if (($opEqualY(q,"E")||$opEqualY(q,"F"))) {
        ...
        if ($opEqualY($opAbsolY(q),1)) {
          ...
          $line=187;
          if (($opEqualY(((java.lang.String)s).length(),0)&&!$opEqualY(\u03C3,'&'))) {
            $line=188;
            ...
            $line=189;
            if (($opEqualY(((java.lang.String)s).length(),1)&&!$opEqualY(\u03C3,'&'))) {
              $line=190;
              ...
              $line=191;
              if (($opEqualY(((java.lang.String)s).length(),2)&&!$opEqualY(\u03C3,'&'))) {
                $line=192;
                $result=GCollections.asList($opAdditY($opAdditY("",s),\u03C3));
                if (true) break $try;
              }
          ...
          $line=202;
          Object $v25=$getArrayValue(q,new Object[]{0});
          Object $v26=$getArrayValue(q,new Object[]{1});
          s=$cast(String.class,$fix($v25));
          Object p=$fix($v26);
          $line=204;
          if ($bool($invokeMethod(CeeDee.class,"isPalindrome",true,null,new Object[]{s}))) {
            $line=205;
